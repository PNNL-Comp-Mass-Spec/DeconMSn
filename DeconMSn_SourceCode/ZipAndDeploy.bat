...
Set InstallerFolder=%ProgramName%Installer\Release
...
for %%i in (%SourceCodeFile%) do "c:\program files (x86)\winrar\winRar.exe" u -r %%i *.cpp *.h
...
"c:\program files (x86)\winrar\winRar.exe" a -ep %ZippedInstallerFile% ..\%InstallerFolder%\*.msi ..\%InstallerFolder%\*.exe ..\%InstallerFolder%\*.ini ..\%InstallerFolder%\*.cab
