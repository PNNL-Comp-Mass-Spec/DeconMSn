...
namespace Engine
{
	namespace PeakProcessing
	{
		...
		public:
			...
			void ApplyMovingAverageFilter(std::vector<double> *vect_mz, std::vector<double> *vect_intensity, int num_points);
			...
			*/
			...
			bool ConvertPeakListToSpectra(std::vector<double> *vect_mz, std::vector<double> *vect_intensity);

			double GetClosestPeakMzFast(double peakMz, Engine::PeakProcessing::Peak &selectedPeak);

			double GetClosestPeakMz(double peakmz, Engine::PeakProcessing::Peak &selectedPeak);
