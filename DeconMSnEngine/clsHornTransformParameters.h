...
namespace Decon2LS
{
	namespace HornTransform
	{
		...
		public __gc class clsHornTransformParameters: public System::ICloneable
		{
			...
			Decon2LS::clsElementIsotopes *mobjElementIsotopes ; 
			int mint_min_scan ; 
			int mint_max_scan ; 
		...
		public:
			...
			virtual Object* Clone()
			{
				...
				new_params->set_ElementIsotopeComposition(static_cast<Decon2LS::clsElementIsotopes*>(this->get_ElementIsotopeComposition()->Clone())) ; 
