 ...
 namespace Readers
{
	...
	public:
		...
		virtual bool IsZoomScan(int scan_num) = 0;
		...
		virtual double GetSummedSpectraFast(std::vector <double> *mzs, std::vector <double> *intensities, int scan_num, int scan_range, double minMz, double maxMz)		; 
