 ...
 namespace Readers
	{
		...
		public:
			...
			__property Decon2LS::Readers::ApodizationType get_ApodizationType()
			{
				return menmApodizationType ; 
			}
			__property void set_ApodizationType(Decon2LS::Readers::ApodizationType value)
			{
			...
			__property Decon2LS::Readers::CalibrationType get_CalibrationType()
			{
				return menmCalibrationType ; 
			}

			__property void set_CalibrationType(Decon2LS::Readers::CalibrationType type)
			{
