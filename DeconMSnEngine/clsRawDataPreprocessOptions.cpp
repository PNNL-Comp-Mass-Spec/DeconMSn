				...
				switch (rdr->NodeType)
				{
					case System::Xml::XmlNodeType::Element:
						if (rdr->Name->Equals(S"ApodizationType"))
						{
							...
							if (rdr->Value->Equals(__box(Decon2LS::Readers::ApodizationType::HANNING)->ToString()))
							{
								this->ApodizationType = Decon2LS::Readers::ApodizationType::HANNING ;
							}
							else if (rdr->Value->Equals(__box(Decon2LS::Readers::ApodizationType::PARZEN)->ToString()))
							{
								this->ApodizationType = Decon2LS::Readers::ApodizationType::PARZEN ;
							}
							else if (rdr->Value->Equals(__box(Decon2LS::Readers::ApodizationType::SQUARE)->ToString()))
							{
								this->ApodizationType = Decon2LS::Readers::ApodizationType::SQUARE ;
							}
							else if (rdr->Value->Equals(__box(Decon2LS::Readers::ApodizationType::TRIANGLE)->ToString()))
							{
								this->ApodizationType = Decon2LS::Readers::ApodizationType::TRIANGLE ;
							}
							else if (rdr->Value->Equals(__box(Decon2LS::Readers::ApodizationType::WELCH)->ToString()))
							{
								this->ApodizationType = Decon2LS::Readers::ApodizationType::WELCH ;
							}
							else
							{
								this->ApodizationType = Decon2LS::Readers::ApodizationType::NOAPODIZATION ;
							}
						}
						...
						else if (rdr->Name->Equals(S"CalibrationType"))
						{
							...
							System::Type *type = __typeof(Decon2LS::Readers::CalibrationType) ; 
							//System::Type::GetType(S"Decon2LS::Readers::CalibrationType") ; 
							Decon2LS::Readers::CalibrationType calibrationType = *dynamic_cast<__box Decon2LS::Readers::CalibrationType*>(Enum::Parse(type, rdr->Value));
