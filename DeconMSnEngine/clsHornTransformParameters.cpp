...
namespace Decon2LS
{
	namespace HornTransform
	{
		clsHornTransformParameters::clsHornTransformParameters(void)
		{
			...
			mobjElementIsotopes = new Decon2LS::clsElementIsotopes() ; 
			...
			mshort_sg_right = 2  ;
			mshort_sg_order = 2  ;
			menmFitType = Decon2LS::enmIsotopeFitType::AREA ;
				...
				switch (rdr->NodeType)
				{
					case XmlNodeType::Element:
						...
						else if (rdr->Name->Equals(S"IsotopeFitType"))
						{
							...
							if (rdr->Value->Equals(__box(Decon2LS::enmIsotopeFitType::AREA)->ToString()))
							{
								this->IsotopeFitType = Decon2LS::enmIsotopeFitType::AREA ;
							}
							else if (rdr->Value->Equals(__box(Decon2LS::enmIsotopeFitType::PEAK)->ToString()))
							{
								this->IsotopeFitType = Decon2LS::enmIsotopeFitType::PEAK ;
							}
							else if (rdr->Value->Equals(__box(Decon2LS::enmIsotopeFitType::CHISQ)->ToString()))
							{
								this->IsotopeFitType = Decon2LS::enmIsotopeFitType::CHISQ ;
							}
						}
						break ; 
