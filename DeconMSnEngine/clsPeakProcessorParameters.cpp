				...
				switch (rdr->NodeType)
				{
					case XmlNodeType::Element:
						...
						else if (rdr->Name->Equals(S"PeakFitType"))
						{
							...
							if (rdr->Value->Equals(__box(Decon2LS::Peaks::PEAK_FIT_TYPE::QUADRATIC)->ToString()))
							{
								this->PeakFitType = Decon2LS::Peaks::PEAK_FIT_TYPE::QUADRATIC ;
							}
							else if (rdr->Value->Equals(__box(Decon2LS::Peaks::PEAK_FIT_TYPE::LORENTZIAN)->ToString()))
							{
								this->PeakFitType = Decon2LS::Peaks::PEAK_FIT_TYPE::LORENTZIAN ;
							}
							else if (rdr->Value->Equals(__box(Decon2LS::Peaks::PEAK_FIT_TYPE::APEX)->ToString()))
							{
								this->PeakFitType = Decon2LS::Peaks::PEAK_FIT_TYPE::APEX ;
							}
						}
						break ; 
