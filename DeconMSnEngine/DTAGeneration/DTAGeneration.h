		...
		{		
			...
			public:					
				...
				*/
				...
				void SetSpectraProcessingOptions(int spectra_type);
				...
				void WriteSpectrumToFile (int scan_num, std::vector <double> *mzs, std::vector <double> *intensities);
				...
				void SetPeakParameters(double pkBkgRatio, double peptideMinBkgRatio);
				...
				bool IsZoomScan(int parent_scan);
