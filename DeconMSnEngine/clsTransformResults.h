...
namespace Decon2LS 
{
	namespace Results
	{
		public __gc class clsTransformResults
		{
			...
			Decon2LS::Readers::FileType menmFileType ; 
		public:
			...
			bool IsDeisotoped() ; 
			void GetRawData(Decon2LS::Results::clsLCMSPeak* (&lcms_peaks) __gc []) ;
			void GetRawDataSortedInIntensity(Decon2LS::Results::clsLCMSPeak* (&lcms_peaks) __gc []) ;
			...
			__property void set_FileType(Decon2LS::Readers::FileType fileType)
			{
