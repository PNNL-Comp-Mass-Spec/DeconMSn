...
namespace Decon2LS
{
	...
	void clsTransformFile::ReadFile(System::String *file_name, Decon2LS::Results::clsTransformResults *results, 
	...
	void clsTransformFile::WritePeaks(std::fstream &fout, Decon2LS::Results::clsTransformResults *results)
	{
	...
	void clsTransformFile::WriteFile(System::String *file_name, Decon2LS::Results::clsTransformResults *results, 
		Peaks::clsPeakProcessorParameters *peak_parameters, HornTransform::clsHornTransformParameters *transform_parameters)
	{
	...
	void clsTransformFile::WriteFile(char *file_name, Decon2LS::Results::clsTransformResults *results, 
		Peaks::clsPeakProcessorParameters *peak_parameters, HornTransform::clsHornTransformParameters *transform_parameters)
	{
