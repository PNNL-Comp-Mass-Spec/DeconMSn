...
namespace Decon2LS
{
	public __gc class clsTransformFile
	{
		...
		void WritePeaks(std::fstream &fout, Decon2LS::Results::clsTransformResults *results) ; 
	public:
		clsTransformFile(void);
		~clsTransformFile(void);
		void ReadFile(System::String *file_name, Decon2LS::Results::clsTransformResults *results, 
			Peaks::clsPeakProcessorParameters *peak_parameters, HornTransform::clsHornTransformParameters *transform_parameters) ; 
		void WriteFile(System::String *file_name, Decon2LS::Results::clsTransformResults *results, 
			Peaks::clsPeakProcessorParameters *peak_parameters, HornTransform::clsHornTransformParameters *transform_parameters) ; 
		void WriteFile(char *file_name, Decon2LS::Results::clsTransformResults *results, 
			Peaks::clsPeakProcessorParameters *peak_parameters, HornTransform::clsHornTransformParameters *transform_parameters) ; 
	};
}